...
c ...................................................................
        ...
        subroutine leelineasiii(iln,atom,istage,wlengt,zeff,energy,
     &                       loggf,mult,design,tam,alfa,sigma,nlow,nup)
        implicit real*4 (a-h,o-z)

        integer mult(2),nlow,nup
        real tam(2),loggf,wlengt,zeff,alfa,sigma,rlow,rup
...
c        stop
        ...
        nup=nint(rup)
c        if(nup .ne. 0 .and. nlow.ne.0)print*,atom,istage,' line at ',wlengt,'in NLTE',nlow,nup 
c        print*,'leelineasiii nlow nup',linea,'-','rlow=',rlow,'nlow=',nlow,'rup=',rup,'nup=',nup
