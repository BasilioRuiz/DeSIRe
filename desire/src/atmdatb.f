...
C       A.D. WITTMANN, GOETTINGEN (1975).
      ...
      real*4 eps(narh)  ! lleva 7 elementos finales que RH necesita
      character*2 elm
...
100   continue
      ...
      call error(KSTOP,'atmdatb','An element in the file containing the'
     & //        ' atomic parameters cannot be identified')
...
12    U1=1.+EXP(-4.027262-X*(6.173172+X*(2.889176+X*(2.393895+.784131*X) ! MG
	...
	du2=-dx*(7.600678+x*(2.*1.966097+3.*x*.212417))
	du2=du2*(u2-2.)/u2
      	if(T.GT.2e4)then
