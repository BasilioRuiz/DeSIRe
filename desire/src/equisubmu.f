...
c _______________________________________________________________
        ...
        precitera=1.e-5
        nmaxitera=250
c       boltz=1.3806488e-16
c       cotane=5.99e8   inferior value of electronic population (ne)
        cotaT_pe=8.2700858e-08  !boltz*cotane = inferior value of T/pe
...
c integramos
        do i=ntau-1,1,-1
           ...
           if(psi .lt. cotaT_pe*tsi)psi=cotaT_pe*tsi
           pe(i)=psi
...
c               call error(KWARN,'equisubmu','Hydrostatic equilibrium'
c     &         //         ' results in inaccurate electron pressures')
c            end if
