...
c _______________________________________________________________
	...
	g=mu*2.7414e+4		!gravedad cm/s^2 en fotosfera solar   
        ...
        do i=1,ntau
c           tau(i)=tau1(i)+alog10(abs(cth))  !this is the optical depth in
            tau(i)=tau1(i)+alog10(abs(mu))  !this is the optical depth in
...
c integramos
	   ...
	   pesomedio=pmusum/(asum+pp(8)) !peso molec. medio
	      ...
	      pesomedio=pmusum/(asum+pp(8)) !peso molec. medio
            ...
            if(dif.gt.0.1)then
               call error(KWARN,'equisubmu_contmag','Hydrostatic equilibrium'
