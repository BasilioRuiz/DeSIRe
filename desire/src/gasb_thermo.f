c	gasb_thermo calcula las preiones parciales y sus derivadas con
c	respectoa la temperatura y la presion.es una modificacion
c	de la rutina gas.

C calcula la energia interna de ionozacion y las derivadas
c de su logaritmoa t y pe

c	dp es la derivada de logp respecto a t, ddp respecto de logp respecto a pe.
...
c	...............................................................
      ...
      parameter (eV=1.6021766e-12) !1 eV en ergios
        ...
        dimension u0(ncontr),u1(ncontr),u2(ncontr)
	dimension du0(ncontr),du1(ncontr),du2(ncontr),dcmol(91)
	real p(99),dp(99),ddp(99)
	real*4 sum_pot_ion,dlsum_pot_ion,ddlsum_pot_ion    !NEW 11 abril 2013
	real*4 u_ion,du_ion,ddu_ion                        !NEW 11 abril 2013		
...
c	ahora exraigo las f. de particion u0,u1,u2 y sus derivadas
      do 5 i=1,ncontr
      		iii=i
...
4     	  call nelfctb(iii,t,u0(iii),u1(iii),u2(iii),du0(iii),du1(iii),
	...
	ddlg1=0.
      ...
      sum_pot_ion=0.      !NEW 11 abril 2013
        dlsum_pot_ion=0.  !NEW 11 abril 2013
        ddlsum_pot_ion=0. !NEW 11 abril 2013
...
c para el calculo de la energia interna y sus drivadas 
C ncesitamos sumar los potenciales de ionizacion * las presiones parciales
       enerfac=chi1(i)+b*(chi1(i)+chi2(i)) 
          denerfac=db*(chi1(i)+chi2(i))/enerfac
          ddenerfac=ddb*(chi1(i)+chi2(i))/enerfac
       eneri=p(i)*a*enerfac
          deneri=dp(i)+da+denerfac
          ddeneri=ddp(i)+dda+ddenerfac
        sum_pot_ion=sum_pot_ion+eneri                      !NEW 11 abril 2013
          dlsum_pot_ion=dlsum_pot_ion+eneri*deneri         !NEW 11 abril 2013
          ddlsum_pot_ion=ddlsum_pot_ion+eneri*ddeneri     !NEW 11 abril 2013
...
c      print*,'gasb fin'
        ...
        sum_pot_ion=sum_pot_ion+eneri                      !NEW 11 abril 2013
          dlsum_pot_ion=dlsum_pot_ion+eneri*deneri         !NEW 11 abril 2013
          ddlsum_pot_ion=ddlsum_pot_ion+eneri*ddeneri      !NEW 11 abril 2013
	sum_pot_ion=sum_pot_ion*eV                         !pasamos a ergios NEW 11 abril 2013
	dlsum_pot_ion=dlsum_pot_ion*eV                     !NEW 11 abril 2013 derivadas lineales
	ddlsum_pot_ion=ddlsum_pot_ion*eV                   !NEW 11 abril 2013 derivadas lineales

      u_ion=phtot/(1.38054e-16*t)*sum_pot_ion          !NEW 11 abril 2013 POR UNIDAD DE VOLUMEN
      du_ion=dphtot-1./t+dlsum_pot_ion/sum_pot_ion     !NEW 11 abril 2013 derivadas logaritmo
      ddu_ion=ddphtot+ddlsum_pot_ion/sum_pot_ion       !NEW 11 abril 2013 derivadas logaritmo
